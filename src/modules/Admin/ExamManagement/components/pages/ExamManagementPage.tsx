...
import { ExamFilter } from '@/modules/Admin/ExamManagement/components/filters/ExamFilter';
import { ExamTable } from '@/modules/Admin/ExamManagement/components/tables/ExamTable';
...
import type { Exam } from '@/modules/Admin/ExamManagement/types/exam.types';
import { getDefaultFilters } from '@/modules/Admin/ExamManagement/utils/getDefaultFilters';
...
export const ExamManagementPage = () => {
  ...
  const handleViewDetails = (exam: Exam) => {
    navigate(`${ADMIN_PRIVATE_ENDPOINTS.EXAM_MANAGEMENT}/${exam.id}`);
  };
  ...
  return (
    <div className="space-y-6 p-6">
      <div className="flex items-center justify-between">
        ...
        <Button onClick={() => navigate(`${ADMIN_PRIVATE_ENDPOINTS.EXAM_CREATE}`)}>
