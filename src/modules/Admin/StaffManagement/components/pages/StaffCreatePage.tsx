...
import StaffCreateForm from '@/modules/Admin/StaffManagement/components/form/StaffCreateForm';
import { type StaffCreateFormData } from '@/modules/Admin/StaffManagement/schemas/staff.schema';
...
export const StaffCreatePage = () => {
  ...
  const createStaffMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      navigate(ADMIN_PRIVATE_ENDPOINTS.STAFF_MANAGEMENT);
