...
import { AuthService } from '@/modules/Student/Auth/services/auth.service';
import { setCredentials } from '@/modules/Student/Auth/store/auth.slice';
...
export const LoginPage = () => {
  ...
  const loginMutation = useMutation({
    ...
    onSuccess: (data) => {
      ...
      navigate(STUDENT_PRIVATE_ENDPOINTS.PROFILE);
    },
    onError: (error) => {
    ...
    <div className="from-primary-50 to-primary-100 flex min-h-screen items-center justify-center bg-gradient-to-br p-4">
      <div className="w-full max-w-md space-y-8 rounded-xl bg-white p-8 shadow-lg">
        <div className="text-center">
          ...
          <p className="mt-2 text-lg text-gray-600">Sign in to your student account</p>
