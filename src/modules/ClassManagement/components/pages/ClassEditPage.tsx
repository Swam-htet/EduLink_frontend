...
import { ClassEditForm } from '@/modules/ClassManagement/forms/ClassEditForm';
...
export const ClassEditPage = () => {
  ...
  const updateClassMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      navigate(`${PRIVATE_ENDPOINTS.CLASS_MANAGEMENT}/${id}`);
    },
  ...
  const handleCancel = () => {
    confirm({
      ...
      onConfirm: () => navigate(`${PRIVATE_ENDPOINTS.CLASS_MANAGEMENT}/${id}`)
    });
  };
