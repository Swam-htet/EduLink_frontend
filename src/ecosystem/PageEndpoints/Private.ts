export const PRIVATE_ENDPOINTS = {
  ...
  STUDENT_DETAIL: '/student-management/:id',
  ...
  CLASS_MANAGEMENT_CREATE: '/class-management/new',
  CLASS_SCHEDULE_MANAGEMENT: '/class-schedule-management',
  CLASS_MANAGEMENT_EDIT: '/class-management/:id/edit',
  CLASS_MANAGEMENT_DETAIL: '/class-management/:id',
